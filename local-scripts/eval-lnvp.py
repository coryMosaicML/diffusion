...
from diffusion.models.models import lnvp
...
parser.add_argument('--time_as_input', action='store_true', help='use time as input')
...
model = lnvp(model_name='stabilityai/stable-diffusion-2-base',
             val_metrics=[],
             pretrained=False,
             encode_latents_in_fp16=False,
             fsdp=False,
             time_as_input=args.time_as_input)
